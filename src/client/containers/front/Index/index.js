...
import {loadAllFoods, searchFoods} from "../../../redux/actions/food.action";
...
class Index extends React.Component {
    ...
    onSearch = () => {
        this.props.searchFoods(this.state.searchTerm);
    };
    ...
    render() {
        ...
        return (
            <>
                <Banner appName="FoodByMe" onClick={this.onSearch} setSearchTerm={this.setSearchTerm}/>
...
export default withRouter(
    connect(mapStateToProps, {loadAllFoods, loadCart, addToCart, searchFoods})(
        withLayout(Index)
    )
);
