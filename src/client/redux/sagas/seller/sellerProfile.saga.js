 ...
 * @param {sellerId} data
 */
function* loadSellerFoodByUser(data) {
  let res;
  try {
    res = yield call(lib.loadSellerFoodByUser, data.payload);
...
export default function* rootSaga() {
  yield all([
    ...
    takeLatest(SELLER_PROFILE_ACTION.USER_FOOD_LOAD, loadSellerFoodByUser),
